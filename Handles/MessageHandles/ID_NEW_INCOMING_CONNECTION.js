...
class ID_NEW_INCOMING_CONNECTION_HANDLE extends MessageHandler {
    constructor() {
        super();
        this.type = RakMessages.ID_NEW_INCOMING_CONNECTION;
        /**
         *
...
module.exports = ID_NEW_INCOMING_CONNECTION_HANDLE;